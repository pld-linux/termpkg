...
na dostęp do jednego lub więcej portów szeregowych poprzez protokół
telnet. Może być skonfigurowany do łączenia portów szeregowych i
telnet jeden do jednego lub w stylu round-robin, gdzie jeden port
telnet służy wielu portom szeregowym.
